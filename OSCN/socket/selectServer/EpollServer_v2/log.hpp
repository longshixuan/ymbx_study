...
namespace ymbx
{
    ...
    std::string getTime(){
        ...
        std::string retstr;
        retstr=std::to_string(rettime->tm_year) + "/" + std::to_string(rettime->tm_mon) + "/" +std::to_string(rettime->tm_mday) + " " +std::to_string(rettime->tm_hour) + ":" + std::to_string(rettime->tm_min) + ":" +std::to_string(rettime->tm_sec);
        return retstr;
    }
